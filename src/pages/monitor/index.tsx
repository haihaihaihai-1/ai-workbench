...
import { MonitorLiveView } from "./MonitorLiveView";
...
const initialViewMode: ViewMode = "overview";
      ...
      {view === "overview" ? (
        <>
          ...
          <header className="flex flex-wrap items-end justify-between gap-3">
            ...
            <div
              className="inline-flex h-7 items-center justify-center rounded-md bg-muted p-0.5 text-muted-foreground"
              role="tablist"
            >
              <button
                type="button"
                role="tab"
                aria-selected={(view as string) === "overview"}
                onClick={() => setView("overview" as ViewMode)}
                className={cn(
                  "inline-flex h-6 items-center gap-1 rounded-sm px-2.5 text-xs font-medium transition-all",
                  (view as string) === "overview"
                    ? "bg-background text-foreground shadow-sm"
                    : "hover:text-foreground",
                )}
              >
                <Activity className="h-3 w-3" /> 概览
              </button>
              <button
                type="button"
                role="tab"
                aria-selected={(view as string) === "live"}
                onClick={() => setView("live" as ViewMode)}
                className={cn(
                  "inline-flex h-6 items-center gap-1 rounded-sm px-2.5 text-xs font-medium transition-all",
                  (view as string) === "live"
                    ? "bg-background text-foreground shadow-sm"
              ...
              >
                <Rss className="h-3 w-3" /> Grafana Live
              </button>
            </div>
            <div className="flex flex-wrap items-center gap-2">
              <span className="hidden text-xs text-muted-foreground sm:inline">
                ...
                <span className="font-mono text-foreground">
                  {formatDate(lastRefresh, "HH:mm:ss")}
                </span>
              </span>
