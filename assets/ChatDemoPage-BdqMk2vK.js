import{r as u,j as e}from"./vendor-react-CO7I8bpx.js";import{j as R,o as C,aa as P,S as $,c as N,ab as T,ac as W}from"./index-BDC1w0ai.js";import"./vendor-utils-CyCIFleB.js";import"./vendor-radix-Fz5CEUld.js";import"./vendor-state-B3AHK1Qu.js";import"./vendor-ui-Ba6RHjD9.js";import"./vendor-icons-BQ9jh7oJ.js";import"./vendor-motion-2qSBuASC.js";function J(s){const n=new TextEncoder,i=s.model??"mock-gpt-4o",l=s.chunkDelayMs??30,c=s.chunkSize??3,f=[...s.messages].reverse().find(r=>r.role==="user"),m=_(f?.content??"");return new ReadableStream({start(r){const d=`chatcmpl-${Math.random().toString(36).slice(2,12)}`,a=Math.floor(Date.now()/1e3),t={id:d,object:"chat.completion.chunk",created:a,model:i,choices:[{index:0,delta:{role:"assistant"},finish_reason:null}]};r.enqueue(n.encode(`data: ${JSON.stringify(t)}
